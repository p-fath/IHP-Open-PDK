...
hbt_typ_mismatch ... with mismatch modelling (not implemented!)
hbt_typ_stat ... with statistical modelling
hbt_typ_stat_mismatch ... with statistical and with mismatch modelling (not implemented!)} -210 -1040 0 0 0.3 0.3 {layer=11}
...
*.lib $::SG13G2_MODELS_XYCE/cornerHBT.lib hbt_typ_mismatch
