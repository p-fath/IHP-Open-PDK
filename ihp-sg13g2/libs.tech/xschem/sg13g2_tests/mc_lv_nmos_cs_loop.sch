...
mos_tt_stat_mismatch ... with statistical and with mismatch modelling} 380 -590 0 0 0.3 0.3 {layer=11}
T {Ctrl-Click to execute launcher} 380 -310 0 0 0.3 0.3 {layer=11}
N 480 -20 480 40 {
lab=GND}
N 480 -50 530 -50 {
lab=GND}
...
C {devices/gnd.sym} 730 40 0 0 {name=l3 lab=GND}
C {devices/gnd.sym} 780 40 0 0 {name=l6 lab=GND}
C {devices/isource.sym} 730 -150 0 0 {name=I1 value=10u}
C {devices/gnd.sym} 730 -200 2 0 {name=l7 lab=GND}
C {devices/lab_pin.sym} 630 -100 0 0 {name=p2 sig_type=std_logic lab=Vgs1}
C {sg13g2_pr/sg13_lv_nmos.sym} 710 -50 0 0 {name=M2
l=0.45u
w=1.0u
ng=1
m=1
...
C {devices/code_shown.sym} 380 -450 0 0 {name=MODEL only_toplevel=true
...
"}
C {launcher.sym} 440 -270 0 0 {name=h3
...
simulate
"}
C {devices/code_shown.sym} -290 -510 0 0 {name=NGSPICE only_toplevel=true 
value="
.param temp=27
